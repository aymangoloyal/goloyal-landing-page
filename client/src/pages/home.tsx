...
import goLoyalLogo from "@assets/generated_images/transparent_GoLoyal_wallet_logo_80c2d85e.png";
import {
  Settings,
  Smartphone,
  BarChart3,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <img src={goLoyalLogo} alt="GoLoyal Logo" className="h-8 w-auto" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-primary-blue transition-all duration-300 text-lg px-8 py-4"
